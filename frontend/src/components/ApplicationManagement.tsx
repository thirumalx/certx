...
export function ApplicationManagement() {
  ...
  const filteredApplications = applications.filter((app) => {
    ...
    if (selectedFilter === 'Active') return matchesSearch && app.status.toLowerCase() === 'active';
    if (selectedFilter === 'Deleted') return matchesSearch && app.status.toLowerCase() === 'deleted';
              ...
              <div className="pagination">
                ...
                <div className="page-numbers">
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    // Show up to 5 pages around current page if possible
                    let pageNum = i;
                    if (totalPages > 5) {
